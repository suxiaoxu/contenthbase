package contenthbase.conten.hbase;
...
public class HbaseTest {
    ...
    static {
        ...
        conf.set("hbase.zookeeper.quorum", "192.168.0.104");*/
    	conf = HBaseConfiguration.create();
    	conf.set("hbase.zookeeper.property.clientPort", "2181");  
    	conf.set("hbase.zookeeper.quorum", "192.168.0.104");  
    	//conf.set("hbase.master", "192.168.0.104:600000");  
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        deleteTable("blog2");*/
    	 ...
    	 // 查询
        //getResult("noteshbase", "0101100000000001100000110000000011000000100200");
    	 getResultByColumn("noteshbase", "0101100000000001100000110000000011000000100200", "content", "details");
